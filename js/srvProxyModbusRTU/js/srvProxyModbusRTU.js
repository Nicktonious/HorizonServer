...
EVENT_MODBUS_LIST = ['proxymodbusrtu-send', 'proxymodbusrtu-msg-get'];
BUS_NAMES_LIST = ['sysBus', PRIMARY_BUS, 'logBus'];

class ProxyModbusRTU extends ClassBaseService_S {
    #_SourceMapNames;
    /**
     * @constructor
     * @description
    ...
    constructor({ _busList, _node }) {
        ...
        this.EmitEvents_logger_log({level: 'I', msg: 'ProxyModbusRTU initialized.'});
    }
    ...
    HandlerEvents_proxymodbusrtu_send(_topic, _msg) {
        ...
        if (source != undefined) {
            this.EmitEvents_modbusclientrtu_send({ arg: [_msg.arg, source.chNum], value: [_msg.value[0]]});
        }
    }
    /**
     * @method 
     ...
     * @param {*} param0 
     */
    EmitEvents_modbusclientrtu_send({ arg, value }) {
        const msg = {
            dest: 'modbusclientrtu',
            com: 'modbusclientrtu-send',
            arg,
            value
        }
        this.EmitMsg(PRIMARY_BUS, msg.com, msg);
